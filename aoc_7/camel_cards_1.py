...
def get_hand_type(hand_map):
    if 5 in hand_map.values():
        return HandType.FIVE_OF_A_KIND
    elif 4 in hand_map.values():
        return HandType.FOUR_OF_A_KIND
    elif 3 in hand_map.values() and 2 in hand_map.values():
        return HandType.FULL_HOUSE
    elif 3 in hand_map.values():
        return HandType.THREE_OF_A_KIND
    elif list(hand_map.values()).count(2) == 2:
        return HandType.TWO_PAIR
    elif list(hand_map.values()).count(2) == 1:
